namespace SongIllustrator {
	partial class TimelineItem {
		...
		private void InitializeComponent() {
			//this.imageIdentifier = newPictureView();
			//((System.ComponentModel.ISupportInitialize)(this.imageIdentifier)).BeginInit();
			//this.SuspendLayout();
			// 
			// imageIdentifier
			// 
			//this.imageIdentifier.ControlBackColor = Color.Red;
			...
			//this.imageIdentifier.ControlLocation = new ControlLocation(0, 0);
			//this.imageIdentifier.Name = "imageIdentifier";
			//this.imageIdentifier.ControlSize = new ControlSize(153, 116);
