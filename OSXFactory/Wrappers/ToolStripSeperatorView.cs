...
namespace OSXFactory.Wrappers {
	public class ToolStripSeparatorWrapper : ControlWrapper, IMenuItemSeperator{
		...
		public ControlSize Size {
			get {
				return new ControlSize((int)this.Control.Bounds.Width, (int)this.Control.Bounds.Height);
			}
			set {
				this.Control.Bounds = new RectangleF (this.Control.Bounds.X, this.Control.Bounds.Y, value.Width, value.Height);
			}
		}
